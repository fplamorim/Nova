...
\newdata{boxdim}
	\spine(logo)={\theboxdim(height)\ \theboxdim(width)}%\includegraphics[height={\noexpand\tcbtextheight},width={\noexpand\tcbtextwidth},keepaspectratio]{nova-fct-logo-negative-en}}
      ...
      at ($(current page.\@GROUPANCHOR)+(\@SPCURPOSX,0)$) {%
                \begin{tcolorbox}[
                        ...
                        \@boxdebug, fit, fit fontsize macros,
									...
									\boxdim(height)={\tcbtextheight}
									\boxdim(width)={\tcbtextwidth}
                  \renewcommand{\baselinestretch}{0.9}%
                  \Huge\thespine(\myi) - \the\tcbtextheight\ \the\tcbtextwidth%
                \end{tcolorbox}%
      };
