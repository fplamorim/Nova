...
\newcommand{\@ntprintspine@i}{%
  ...
  \@SPUNUSEDTOTAL=\dimexpr\@SPMAXLEN-\@SPLEN-\thespine(margin,left)
...
\newcommand{\printspinebox}[2]{%
  ...
  \IfStrEq{#1}{logo}{%
    ...
    \scalebox{\@fbratio}{%
      \datamatchtf{\arg}{spine}({box,#1,text,gz},{box,color,text},{text,color}){\color{\arg}}{}%
