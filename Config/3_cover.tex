...
%         For [type] use: [main]  for the main title
%                         [sub]   for the sub-title
%                         [spine] for the book spine version of the title (if
%                                 omitted defaults to main title without line breaks)
%-------------------------------------------------------------------
...
%         You may use "\\" to force line breaks
% \nttitle(spine,en){A Very Long and Impressive Thesis Title\\with a Forced Line Break}%
% \nttitle(spine,pt){Um Título de Tese Longo\\e com uma Mudança de Linha Forçada}%
