...
\nttitle(main,en){A Very Long and Impressive\\Report Title with a Forced Line Break}%
\nttitle(main,pt){Um Título de Relatório Longo\\e com uma Mudança de Linha Forçada}%
...
%-------------------------------------------------------------------
\ntauthorname(m){Atónio Passos Dias Aguiar Mota}{António Mota}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Nme do orientador na empresa, Cargo/Posição na empresa}
% Co-advisers(s)
...
\ntaddperson{committee}(m,m){Prof.\ Carlos Damásio, Professor Associado, NOVA FCT}
\ntaddperson{committee}(m,m){Prof.\ João M. Lourenço, Professor Associado, NOVA FCT}
